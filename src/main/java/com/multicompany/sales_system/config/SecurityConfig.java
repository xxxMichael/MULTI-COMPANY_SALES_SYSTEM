...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(reg -> reg
                        ...
                        // WebSocket y Chat (público para pruebas)
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/users/{cedula}").hasAnyRole("ADMIN", "MODERATOR")
                        .requestMatchers(HttpMethod.PUT, "/api/users/{cedula}").hasAnyRole("ADMIN", "MODERATOR")
                        .requestMatchers(HttpMethod.DELETE, "/api/users/{cedula}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/users/{cedula}/role").hasRole("ADMIN")

                        // --- CONFIGURACIÓN DEL SISTEMA (solo ADMIN) ---
                        .requestMatchers(HttpMethod.GET, "/api/configuracion/**").hasRole("ADMIN")
                ...
                // 🔹 Desactivar formularios HTML de login y autenticación básica
    ...
    // 🔹 CORS se maneja desde CorsConfig.java (ya existente)
}
